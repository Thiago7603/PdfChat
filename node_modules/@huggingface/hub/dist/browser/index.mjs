...
async function datasetInfo(params) {
  ...
  const response = await (params.fetch || fetch)(
    `${(params == null ? void 0 : params.hubUrl) || HUB_URL}/api/datasets/${params.name}/revision/${encodeURIComponent((_c = params.revision) != null ? _c : "HEAD")}?${search.toString()}`,
    {
      headers: {
        ...accessToken ? { Authorization: `Bearer ${accessToken}` } : {},
...
async function modelInfo(params) {
  ...
  const response = await (params.fetch || fetch)(
    `${(params == null ? void 0 : params.hubUrl) || HUB_URL}/api/models/${params.name}/revision/${encodeURIComponent((_c = params.revision) != null ? _c : "HEAD")}?${search.toString()}`,
    {
      headers: {
        ...accessToken ? { Authorization: `Bearer ${accessToken}` } : {},
        Accepts: "application/json"
...
async function pathsInfo(params) {
  ...
  const repoId = toRepoId(params.repo);
  const hubUrl = (_a = params.hubUrl) != null ? _a : HUB_URL;
  const url = `${hubUrl}/api/${repoId.type}s/${repoId.name}/paths-info/${encodeURIComponent((_b = params.revision) != null ? _b : "main")}`;
  const resp = await ((_c = params.fetch) != null ? _c : fetch)(url, {
    method: "POST",
    headers: {
      ...params.credentials && {
...
async function spaceInfo(params) {
  ...
  const response = await (params.fetch || fetch)(
    `${(params == null ? void 0 : params.hubUrl) || HUB_URL}/api/spaces/${params.name}/revision/${encodeURIComponent((_c = params.revision) != null ? _c : "HEAD")}?${search.toString()}`,
    {
      headers: {
        ...accessToken ? { Authorization: `Bearer ${accessToken}` } : {},
        Accepts: "application/json"
